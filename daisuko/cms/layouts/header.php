...
<head>
    ...
    <title>CMS4.0 - Thương Hiệu Web - 2020</title>
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./"><img src="https://thuonghieuweb.com/oldversion/img/homepage/logo-thuonghieu.png" alt="Logo"></a>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                     ...
                     <!-- <li>
                        <a href="thongtin_en"> <i class="menu-icon fa fa-laptop"></i>Thông tin website EN</a>
                    </li> -->
                    <li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa fa-map-o"></i><a href="nsx">Nhà sản xuất</a></li>
                            <li><i class="menu-icon fa fa fa-paper-plane"></i><a href="phukien">Phụ kiện</a></li>
                        </ul>
                    </li>
                    <!--  <li>
                        <a href="link"> <i class="menu-icon fa fa-map-o"></i>Link</a>
                    </li>
                    <li>
                        <a href="trangdichvu"> <i class="menu-icon fa fa-map-o"></i>Trang dịch vụ</a>
                    </li> -->
                    <li>
                        <a href="donhang"> <i class="menu-icon fa fa-map-o"></i>Đấu giá</a>
                    </li>
                    <li>
                        <a href="ketqua"> <i class="menu-icon fa fa-map-o"></i>Kết quả</a>
                    </li>
                   <!--  <li>
                        <a href="link"> <i class="menu-icon fa fa-map-o"></i>Nhà sản xuất</a>
                    </li>
 -->
                    <!-- <h3 class="menu-title">Quản lý đơn hàng</h3><!-- /.menu-title -->
                    <!-- <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-glass"></i>Khách hàng</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa fa-map-o"></i><a href="khachhang">Đại lý</a></li>
                            <li><i class="menu-icon fa fa-sign-in"></i><a href="nhanvien">Trình dược viên</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-paper-plane"></i>Đơn hàng</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa fa-table"></i><a href="donhang">Đơn hàng</a></li>
                            <li><i class="menu-icon fa fa-sign-in"></i><a href="doanhthu">Doanh thu</a></li>
                            <li><i class="menu-icon fa fa-paper-plane"></i><a href="phiship">Chi phí ship</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-bar-chart"></i>Báo cáo</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-tasks"></i><a href="page-login.html">Doanh thu đại lý</a></li>
                            <li><i class="menu-icon fa fa-sign-in"></i><a href="page-register.html">Doanh thu trình dược</a></li>
                            <li><i class="menu-icon fa fa-paper-plane"></i><a href="pages-forget.html">Doanh thu sản phẩm</a></li>
                            <li><i class="menu-icon ti-email"></i><a href="pages-forget.html">Doanh thu đơn hàng</a></li>
                        </ul>
                    </li> -->
                    <!-- <li class="menu-item-has-children dropdown">
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            ...
                            <a class="nav-link" href="index/doimatkhau"><i class="fa fa-user"></i> Đổi mật khẩu</a>
