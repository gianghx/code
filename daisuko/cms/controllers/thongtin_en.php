<?php
class thongtin_en extends controller
{
   ...
   function save()
   {
       ...
       if ($this->model->save($id,$data)) {
           $this->view->thongbao = 'Cập nhật thành công! <a href="thongtin_en">Nhấn vào đây để quay lại</a>';
           $this->view->render('thongbao');
       } else {
           $this->view->thongbao = 'Cập nhật không thành công! <a href="thongtin_en">Nhấn vào đây để quay lại</a>';
