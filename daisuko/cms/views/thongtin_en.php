<script type="text/javascript" src="js/thongtin_en.js"></script>
                                      ...
                                      <?php
                                        ...
                                        foreach($this->data as$row){
                                          echo '<tr>
                                              ...
                                              <td><a href="thongtin_en/del?id='.$i.'"><i class="fa fa-trash-o"></i></a>  </td>
                                          </tr>';
                                          $i++;
                                      }
                                      ?>
        ...
        <div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form id="form-client" method="post" enctype="multipart/form-data" action="thongtin_en/save">
