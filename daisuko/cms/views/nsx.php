<script type="text/javascript" src="js/nsx.js"></script>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">nsx</strong>
                                      ...
                                      <?php
                                        ...
                                        foreach($this->data as$row) {
                                            echo '<tr>
                                                ...
                                                <td><a href="nsx/del?id='.$row['id'].'"><i class="fa fa-trash-o"></i></a>  </td>
                                            </tr>';
                                            $i++;
                                        }
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="largeModalLabel">Thông tin nhà sản xuất</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form id="form-client" method="post" enctype="multipart/form-data" action="nsx/save">
                            ...
                            <div class="col-sm-6">
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="name" name="name" placeholder="Tên nsx" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                 <div class="row form-group">
                                    <div class="col col-md-3"><label for="name" class=" form-control-label">Tên EN</label></div>
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="name_en" name="name_en" placeholder="Tên nsx EN" class="form-control" required>
                                    </div>
                                </div>
