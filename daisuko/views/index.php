                ...
                <div class="row">
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <aside class="styled_header  use_icon ">
                            <h2 style="color: red;">Mời đặt mua</h2>
                                ...
                                <div class="product-detail clearfix">
                                    ...
                                    <div class="pro-prices">
                                        <table class="info-product-home">
                                            ...
                                            <tr>
                                                <td><img src="template/img/giasan.png" style="width: 10px;"> Giá bán</td>
                                            ...
                                            <tr>
                                                <td><img src="template/img/timeleft.png" style="width: 10px;"> Hạn chót</td>
                                                <td><span class="pro-price" id="dem3<?= $value['id'] ?>"></span></td>
                                            </tr>
                                            <tr>
                                                <td colspan="2" class="text-center"><a class="btn btn-success" href="product/<?= $value['url'] ?>?phien=<?= $value['id'] ?>" role="button">Đặt mua</a></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                        ...
                        <script>
                            ...
                            var x<?= $value['id'] ?> = setInterval(function() {
                                ...
                                if (distance<?= $value['id'] ?> < 0) {
                                    ...
                                    document.getElementById("dem3<?= $value['id'] ?>").innerHTML = "KẾT THÚC";
                                }
                            }, 1000);
                        </script>
                    <?php } ?>
                            ...
                            <script>
                                ...
                                var x1<?= $value['id'] ?> = setInterval(function() {
                                    ...
                                    if (distance1<?= $value['id'] ?> < 0) {
                                        ...
                                        document.getElementById("dem1<?= $value['id'] ?>").innerHTML = "KẾT THÚC";
                                    }
                                }, 1000);
                            </script>
                        <?php } ?>
                        ...
                        ?>
                            ...
                            <script>
                                ...
                                var x<?= $value['id'] ?> = setInterval(function() {
                                    ...
                                    if (distance<?= $value['id'] ?> < 0) {
                                        clearInterval(x<?= $value['id'] ?>);
                                        document.getElementById("dem4<?= $value['id'] ?>").innerHTML = "KẾT THÚC";
                                    }
                                }, 1000);
                            </script>
                        <?php } ?>
                        ...
                        ?>
                            ...
                            <script>
                                ...
                                var x<?= $value['id'] ?> = setInterval(function() {
                                    ...
                                    if (distance<?= $value['id'] ?> < 0) {
                                        clearInterval(x<?= $value['id'] ?>);
                                        document.getElementById("dem<?= $value['id'] ?>").innerHTML = "Kết thúc";
                                    }
                                }, 1000);
                            </script>
                        <?php } ?>
                        ...
                        ?>
                            ...
                            <script>
                                ...
                                var x<?= $value['id'] ?> = setInterval(function() {
                                    ...
                                    if (distance<?= $value['id'] ?> < 0) {
                                        clearInterval(x<?= $value['id'] ?>);
                                        document.getElementById("dem2<?= $value['id'] ?>").innerHTML = "Kết thúc";
                                    }
                                }, 1000);
                            </script>
                        <?php } ?>
