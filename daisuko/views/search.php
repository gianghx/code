<?php
    if (isset($_REQUEST['keywords']) && $_REQUEST['keywords']!='') {
         $keyword = $_REQUEST['keywords'];
          $sanpham= $data->getsanphamsearch($keyword);
         $tongbv= count($sanpham);
         $trang= isset($_GET['p'])?$_GET['p']:1;
         $sotrang= ceil($tongbv/12);
         $sanpham1= $data->getsanphamsearch1($keyword,$trang);
                                              ...
                                              if (count($con)>0) { ?>
                                                <li class="item has-sub active first">
                                                    <a href="product/1/<?=$value['url']?>">
                                                        ...
                                                        <span data-toggle="collapse" data-parent="#cssmenu" href="#sub-item-1" class="sign drop-down">
                                                        </span>
                                                    </a>
                                                        ...
                                                        <div class="product-detail clearfix">
                                                            ...
                                                            <div class="pro-prices">
                                                                <table class="info-product-home" style="width: 100%;">
                                                                    ...
                                                                    <tr>
                                                                        <td><img src="template/img/giasan.png" style="width: 30px;"> Giá sàn</td>
                                                                        <td><span class="pro-price"><?=number_format($value['gia_san'])?>₫</span></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><img src="template/img/sieuthi.png" style="width: 30px;"> Giá siêu thị</td>
                                                                        <td><span class="pro-price"><?=number_format($value['gia_st'])?>₫</span></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><img src="template/img/timeleft.png" style="width: 30px;"> Còn</td>
                                                                        <td><span class="pro-price" id="dem<?=$value['id']?>"></span></td>
                                                                    </tr>
                                                                     <tr>
                                                                        <td colspan="2" class="text-center"><a class="btn btn-success" href="product/<?=$value['url']?>?phien=<?=$value['id']?>" role="button">Đấu ngay</a></td>
                                                                    </tr>
                                                                </table>
                                                ...
                                                <div id="pagination" class="">
                                                    <div class="col-lg-2 col-md-2 col-sm-3 hidden-xs">
                                                        <?php if ($trang>1 && $sotrang>1) {
                                                            echo '<a class="prev fa fa-angle-left" href="product?p='.($trang-1).'"><span>Trang trước</span></a>';
                                                        } ?>
                                                    ...
                                                    <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 text-center">
                                                        <?php for ($i=1; $i <=$sotrang ; $i++) { 
                                                            if ($trang==$i) {
                                                                ...
                                                                echo '<a class="page-node" href="product?p='.$i.'">'.$i.'</a>';
                                                            }
                                                        } ?>
                                                    ...
                                                    <div class="col-lg-2 col-md-2 col-sm-3 hidden-xs">
                                                        <?php if ($trang<$sotrang) {
                                                            echo '<a class="pull-right next fa fa-angle-right" href="product?p='.($trang+1).'"><span>Trang sau</span></a>';
                                                        } ?>
