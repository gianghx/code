<?php
$baiviet = $page['data'];
if (isset($baiviet) && count($baiviet) > 0) {
    $tongbv = count($baiviet);
    $sotrang = ceil($tongbv / 5);
    $trang = isset($_GET['p']) ? $_GET['p'] : 1;
    $baiviet1 = $data->getbaiviet1($trang);
    $newpost = $data->newpost(5);
                                             ...
                                             <div id="pagination" class="">
                                                    <div class="col-lg-2 col-md-2 col-sm-3 hidden-xs">
                                                        <?php if ($trang>1 && $sotrang>1) {
                                                            echo '<a class="prev fa fa-angle-left" href="blog?p='.($trang-1).'"><span>Trang trước</span></a>';
                                                        } ?>
                                                    ...
                                                    <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 text-center">
                                                        <?php for ($i=1; $i <=$sotrang ; $i++) { 
                                                            if ($trang==$i) {
                                                                ...
                                                                echo '<a class="page-node" href="blog?p='.$i.'">'.$i.'</a>';
                                                            }
                                                        } ?>
                                                    ...
                                                    <div class="col-lg-2 col-md-2 col-sm-3 hidden-xs">
                                                        <?php if ($trang<$sotrang) {
                                                            echo '<a class="pull-right next fa fa-angle-right" href="blog?p='.($trang+1).'"><span>Trang sau</span></a>';
                                                        } ?>
