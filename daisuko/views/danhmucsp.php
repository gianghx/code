<?php
  ...
  if (isset($danhmuc) && count($danhmuc)>0) {
      $sanpham= $data->getsanpham_dm($danhmuc['id']);
      $tongbv= count($sanpham);
      $trang= $url[1];
      $sotrang= ceil($tongbv/12);
      $sanpham1= $data->getsanpham_dm1($danhmuc['id'],$trang);
                        ...
                        <div class="row main-header">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pd5  ">
                                <ol class="breadcrumb breadcrumb-arrows">
                                    ...
                                    <li><a href="product" target="_self">Danh mục</a></li>
                                    <li class="active"><span><?=$danhmuc['name']?></span></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                                        ...
                                                        <div class="product-img image-resize view view-third" style="height: 211px;">
                                                            ...
                                                            <div class="actionss">
                                                                <div class="btn-cart-products">
                                                                    <a href="javascript:void(0)" onclick="addphieu(<?=$value['id']?>,<?=$value['hang_hoa']?>)">
                                                ...
                                                <div id="pagination" class="">
                                                    <div class="col-lg-2 col-md-2 col-sm-3 hidden-xs">
                                                        <?php if ($trang>1 && $sotrang>1) {
                                                            echo '<a class="prev fa fa-angle-left" href="product/'.($trang-1).'/'.$url['2'].'"><span>Trang trước</span></a>';
                                                        } ?>
                                                    ...
                                                    <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 text-center">
                                                        <?php for ($i=1; $i <=$sotrang ; $i++) {
                                                            if ($trang==$i) {
                                                                ...
                                                                echo '<a class="page-node" href="product/'.$i.'/'.$url['2'].'">'.$i.'</a>';
                                                            }
                                                        } ?>
                                                    ...
                                                    <div class="col-lg-2 col-md-2 col-sm-3 hidden-xs">
                                                        <?php if ($trang<$sotrang) {
                                                            echo '<a class="pull-right next fa fa-angle-right" href="product/'.($trang+1).'/'.$url['2'].'"><span>Trang sau</span></a>';
                                                        } ?>
